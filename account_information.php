...
<li class='list-group-item'>
  <form method="POST" action='account_information.php' id='form_change_password'>
    Parola initiala
    ...
    <input type=submit name="change_password" value="Schimba Parola" form="form_change_password">
  </form>
  </li>
    </div>
    <div class="col">
