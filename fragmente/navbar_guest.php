<nav class="navbar navbar-expand-lg p-2 text-bg-header sticky-top">
  <div class="container">
    ...
    border-bottom-right-radius: 50rem !important;">
            ...
            <?php 
            echo "
            <form form='login-form-expanded' id='login-form-expanded' method='POST' action='$pagina_request_login' class='dropdown-menu p-2' style='min-width:15rem !important;background-color:#eeeeee;border-width: 3px;top:100% !important;left:0px !important;'>
            ";
            ?>
              <div class="mb-1">
